...
def eigen(matrix):
    ...
    ans  = "Characteristic Equation: " + formatted_poly
    for eigval in eigenvalues:
        ans = ans + "\n Eigenvalue: " + str(eigval)
        ans = ans + "\n Corresponding Eigenvector: " + str(eigenvectors[eigval][0])
...
def solve_addition(matrix_1, matrix_2):
    matrix_1 = process_matrix(matrix_1)
    matrix_2 = process_matrix(matrix_2)
    matrix_3 = matrix_addition(matrix_1, matrix_2)
    return matrix_3



def solve_subtraction(matrix_1, matrix_2):
    matrix_1 = process_matrix(matrix_1)
    matrix_2 = process_matrix(matrix_2)
...
def solve_multiplication(matrix_1, matrix_2):
    matrix_1 = process_matrix(matrix_1)
    matrix_2 = process_matrix(matrix_2)
...
def solve_inverse(matrix_1):
    matrix_1 = process_matrix(matrix_1)
    matrix_3 = matrix_inverse(matrix_1)
    return matrix_3



def solve_eigen(matrix_1):
    matrix_1 = process_matrix(matrix_1)
    matrix_3 = eigen(matrix_1)
    return matrix_3
